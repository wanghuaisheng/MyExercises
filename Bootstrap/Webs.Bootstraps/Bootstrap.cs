...
using Webs.Bootstraps.Accordion;
using Webs.Bootstraps.Carousel;
using Webs.Bootstraps.DynamicForm;
using Webs.Bootstraps.Form;
using Webs.Bootstraps.HeroUnit;
using Webs.Bootstraps.Modal;
using Webs.Bootstraps.Navigation;
using Webs.Bootstraps.Tabs;
using Webs.Bootstraps.Thumbnails;
using Webs.Bootstraps.Toolbar;
...
namespace Webs.Bootstraps
{
    ...
    public class Bootstrap<TModel>
    {
        ...
        public CarouselBuilder<TModel> Begin(Carousel.Carousel carousel)
        {
            if (carousel == null)
            {
        ...
        public HeroUnitBuilder<TModel> Begin(HeroUnit.HeroUnit heroUnit)
        {
            if (heroUnit == null)
            {
        ...
        public ModalBuilder<TModel> Begin(Modal.Modal modal)
        {
            if (modal == null)
            {
        ...
        public TabsBuilder<TModel> Begin(Tabs.Tabs tabs)
        {
            if (tabs == null)
            {
        ...
        public ToolbarBuilder<TModel> Begin(Toolbar.Toolbar toolbar)
        {
            if (toolbar == null)
            {
